...
public class HypnoseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // später unbedingt auskommentieren/löschen!!!
        tb.putBoolean("played1", false);
        tb.putBoolean("played2", false);
        ...
        for(int z=0; z<3; z++ ) {
            ...
            starts[z].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialog.setNegativeButton("abbrehen", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
